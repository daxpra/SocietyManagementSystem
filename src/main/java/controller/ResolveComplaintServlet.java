    ...
    protected void doPost(HttpServletRequest request,
        ...
        if(idParam == null ||
           idParam.trim().isEmpty()) {
            ...
            response.sendRedirect(
                "adminDashboard?msg=Invalid Complaint"
            );
            return;
        }
        ...
        try {
            ...
            if(rows > 0){
                ...
                response.sendRedirect(
                    "adminDashboard?msg=Complaint Resolved"
                );

            } else {

                response.sendRedirect(
                    "adminDashboard?msg=Complaint Already Resolved Or Not Found"
                );
            }
